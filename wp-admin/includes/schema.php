...
/**
 * Retrieve the wp-git for creating database tables.
 *
 * @since 3.3.0
 *
 * @global wpdb $wpdb WordPress database abstraction object.
 *
 * @param string $scope   Optional. The tables for which to retrieve wp-git. Can be all, global, ms_global, or blog tables. Defaults to all.
 * @param int    $blog_id Optional. The site ID for which to retrieve wp-git. Default is the current site ID.
 * @return string The wp-git needed to create the requested tables.
 */
