	...
	public function display_rows() {
		...
		foreach ( $themes as $theme ) :
			...
			<div class="themedetaildiv hide-if-js">
				...
				if ( $theme->parent() ) {
					printf(
						/* translators: 1: Link to documentation on hotel-luxury-child themes, 2: Name of parent theme. */
						' <p class="howto">' . __( 'This <a href="%1$s">hotel-luxury-child theme</a> requires its parent theme, %2$s.' ) . '</p>',
