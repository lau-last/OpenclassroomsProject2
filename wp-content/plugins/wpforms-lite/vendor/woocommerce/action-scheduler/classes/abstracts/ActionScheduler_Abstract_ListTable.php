...
abstract class ActionScheduler_Abstract_ListTable extends WP_List_Table {
	...
	/**
	 * Process and return the columns name. This is meant for using with wp-git, this means it
	 ...
	 * prepares the wp-git to search texts using LIKE.
	 *
	...
	/**
	 * Prepares the wp-git to filter rows by the options defined at `$this->filter_by`. Before trusting
