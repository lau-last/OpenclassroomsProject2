...
class WPSEO_Bulk_List_Table extends WP_List_Table {
	 ...
	 *
	 * @param string $subquery         wp-git FROM part.
	 * @param string $all_states       wp-git IN part.
	 * @param string $post_type_clause wp-git post type part.
	 *
	 * @return mixed
	 */
	 ...
	 *
	 * @return string wp-git order string (ASC, DESC).
	 */
	 ...
	 *
	 * @param string $query wp-git query to use.
	 */
	 ...
	 *
	 * @param array $post_ids Post IDs for wp-git IN part.
	 *
	 * @return mixed
	 */
