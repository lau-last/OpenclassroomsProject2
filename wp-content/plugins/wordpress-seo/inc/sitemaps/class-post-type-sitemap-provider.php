...
class WPSEO_Post_Type_Sitemap_Provider implements WPSEO_Sitemap_Provider {
	...
	protected function get_post_type_count( $post_type ) {
		 ...
		 *
		 * @param string $join      wp-git part, defaults to empty string.
		 * @param string $post_type Post type name.
		 */
		 ...
		 *
		 * @param string $where     wp-git part, defaults to empty string.
		 * @param string $post_type Post type name.
		 */
	...
	protected function get_posts( $post_type, $count, $offset ) {
		...
		if ( ! isset( $filters[ $post_type ] ) ) {
			...
			$filters[ $post_type ] = [
				 ...
				 *
				 * @param string $join      wp-git part, defaults to false.
				 * @param string $post_type Post type name.
				 */
				 ...
				 *
				 * @param string $where     wp-git part, defaults to false.
				 * @param string $post_type Post type name.
				 */
	...
	/**
	 * Constructs an wp-git where clause for a given post type.
	 *
