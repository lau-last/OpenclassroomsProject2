...
class Adapter {
	...
	/**
	 * Return the wp-git definition of a column.
	 *
	 ...
	 * @param array  $options The options.
	 *
	 * @return string The wp-git statement for the column options.
	 *
	 * @throws Exception If invalid arguments are supplied.
	 */
	 ...
	 * @param string $text The string.
	 *
	 * @return bool Whether or not it's a wp-git function call.
	 */
