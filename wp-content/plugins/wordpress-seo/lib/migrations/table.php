...
class Table {
	...
	/**
	 * The wp-git representation of this table.
	 *
	 * @var string
	 */
	private $sql = '';
	 ...
	 * Table definition
	 *
	 * @param bool $wants_sql Whether or not to return wp-git or execute the query. Defaults to false.
	 *
	 * @return bool|string
	 *
	...
	/**
	 * Get wp-git for all columns.
	 *
	 * @return string The wp-git.
	 */
